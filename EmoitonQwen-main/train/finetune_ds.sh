...
OUTPUT_MODEL_NAME="EmotionQwen_finetune"
...
CUDA_VISIBLE_DEVICES=0,1,2 torchrun $DISTRIBUTED_ARGS finetune.py  \
    ...
    --tune_emotion_compressor true \
    --disable_flash_attn2 false \
    --model_max_length $MODEL_MAX_Length \
    --image_max_pixels $((1280 * 28 * 28)) \
    --video_max_pixels $((448 * 448)) \
    --output_dir train_output/$OUTPUT_MODEL_NAME/model \
    --logging_dir train_output/$OUTPUT_MODEL_NAME/log \
